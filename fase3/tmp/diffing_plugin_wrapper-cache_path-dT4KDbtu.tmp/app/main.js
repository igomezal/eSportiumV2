System.register(['angular2/core', 'angular2/router', './partido.service', './jugador.interface', './cabecera.component', './juego.interface', './index.component', './profile.component', './usuario.interface', './pie.component', './partido.component', './registro.component', './aboutus.component', './faq.component', './contacto.component', './finalizados.component', './editarpefil.component'], function(exports_1) {
    ...
    var core_1, router_1, partido_service_1, jugador_interface_1, cabecera_component_1, juego_interface_1, index_component_1, profile_component_1, usuario_interface_1, pie_component_1, partido_component_1, registro_component_1, aboutus_component_1, faq_component_1, contacto_component_1, finalizados_component_1, editarpefil_component_1;
    var MainApp;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            MainApp = (function () {
                ...
                MainApp = __decorate([
                    core_1.Component({
                        selector: 'main-app',
                        providers: [router_1.ROUTER_PROVIDERS, partido_service_1.PartidoService, jugador_interface_1.JugadorService, juego_interface_1.JuegoService, usuario_interface_1.UsuarioService],
                    ...
                    router_1.RouteConfig([
                        ...
                        { path: '/admin', name: 'Admin', component: index_component_1.indexComponent },
