        ...
        execute: function() {
            RegistroComponent = (function () {
                ...
                RegistroComponent.prototype.add = function (nombre, correo, genero, clave, clave2) {
                    if (clave === clave2) {
                        this._usuarioService.addUsuario(nombre, correo, genero, clave); //Revisar para usar observadores?
                        this.exito = true;
                        this.error = false;
                        this._usuarioService.getUsuarios().subscribe(function (usuario) { return console.log(usuario); }, function (error) { return console.log(error); });
                    }
                    else {
                        this.error = true;
                        this.exito = false;
