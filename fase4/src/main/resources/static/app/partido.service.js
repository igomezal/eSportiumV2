    ...
    return {
        ...
        execute: function() {
            ...
            PartidoService = (function () {
                ...
                PartidoService.prototype.terminarPartido = function (part, equipo) {
                    var _this = this;
                    var url = "https://localhost:8443/partidos/" + part.id;
                    var item = { id: part.id, estado: "Finalizado", ganando: equipo, diferencia: part.diferencia, url: part.url, rondas: part.rondas, juego: part.juego, equipo1: part.equipo1, equipo2: part.equipo2 };
                    var body = JSON.stringify(item);
                    var headers = new http_1.Headers({
                        'Content-Type': 'application/json'
                    });
