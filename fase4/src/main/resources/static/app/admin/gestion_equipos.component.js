        ...
        execute: function() {
            gestionEquiposComponent = (function () {
                ...
                gestionEquiposComponent.prototype.borrarEquipo = function (equipo) {
                    var _this = this;
                    this._EquipoService.eliminar(equipo.id).subscribe(function (respuesta) { alert('Eliminado equipo: ' + equipo.nombre); _this.refresh(); }, function (error) { return console.log(error); });
                };
